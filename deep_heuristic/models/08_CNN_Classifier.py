...
y_train_pics = np.array([x[16:48, -8:] for x in y_train_data[:, 3]]).reshape(-1, 256)
print(x_train_pics.shape)
print(x_train_labels.shape)
print(y_train_pics.shape)
x_train_pics = np.append(x_train_pics, np.flip(y_train_pics.transpose(), axis=1)).reshape(-1, 256)
print(x_train_pics.shape)
x_train_labels = np.append(x_train_labels, y_train_labels)
print(x_train_labels.shape)
y_eval_pics = np.array([x[16:48, -8:] for x in y_eval_data[:, 3]]).reshape(-1, 256)
