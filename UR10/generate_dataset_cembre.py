...
def get_rand(low=0.05, high=0.12):
...
class DataGenerator(object):
    ...
    def reset(self, region=None):
        ...
        obj1 = create_box(get_rand(), get_rand(), get_rand(low=0.12), mass=0.5, color=(0.859, 0.192, 0.306, 1.0))
        obj2 = create_box(get_rand(), get_rand(), get_rand(low=0.12), mass=0.5, color=(0.271, 0.706, 0.490, 1.0))
        obj3 = create_box(get_rand(), get_rand(), get_rand(low=0.12), mass=0.5, color=(0.271, 0.706, 0.490, 1.0))
        obj4 = create_box(get_rand(), get_rand(), get_rand(low=0.12), mass=0.5, color=(0.271, 0.706, 0.490, 1.0))

        self.target_obj = obj1
        self.movable_bodies = [obj1, obj2, obj3, obj4]
    ...
    for i in range(14000):  # 4000
        ...
        if i != 0 and i % 1000 == 0:
            with open(file_data, 'wb') as f:
                pk.dump((np.array(list_X), np.array(list_labels)), f)
